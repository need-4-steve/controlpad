...
// Add a Pool //
////////////////
function AddPool($systemid, $amount, $startdate, $enddate)
{
	$fields[] = "systemid";
	$fields[] = "amount";
	$fields[] = "startdate";
...
// Add a Pool //
////////////////
function EditPool($systemid, $id, $amount, $startdate, $enddate)
{
	$fields[] = "systemid";
	$fields[] = "id";
	$fields[] = "amount";
...
// Disable a pool //
////////////////////
function DisablePool($systemid, $id)
{
	$fields[] = "systemid";
	$fields[] = "id";
	$values["systemid"] = $systemid;
...
// Disable a pool //
////////////////////
function EnablePool($systemid, $id)
{
	$fields[] = "systemid";
	$fields[] = "id";
	$values["systemid"] = $systemid;
