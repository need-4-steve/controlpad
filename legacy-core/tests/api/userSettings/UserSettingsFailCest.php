...
class UserSettingsFailCest
{
    ...
    public function tryToGetAdminSettingsAsRep(UserAuth $I)
    {
        $I->wantTo('Get rep settings as that rep');
        $I->loginAsRep();
        $I->sendGET('/api/v1/user-settings/' . $this->adminUser->id);
        $I->seeResponseCodeIs(403);
    }

    // get a rep's settings as admin
    public function tryToGetReppiSettingsAsAdmin(UserAuth $I)
    {
