...
class ReturnReason extends Model
{
    ...
    */
    ...
    /**
     * The return order requests associated with a particular reason.
     * This will be helpful if we are trying to query based on the
     * state of a return (by admins) to sort the results.
     *
     * @method return
