...
class CreateMcommTestOrders extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        //
        // $rep = User::where('email', 'testaug07afn@gmail.com')->first();
        // if (empty($rep)) {
        //     exit;
        // }
        //
        ...
        // Order::where('store_owner_user_id', $rep->id)->get()->each(function ($order) {
