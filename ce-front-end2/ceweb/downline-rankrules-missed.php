...
/////////////////////////////////////////////////////////////
$fields[] = "userid";
$json = BuildAndPOST(AFFILIATE, "downrankrulesmissed", $fields, $pagvals);
...
<div class="x_panel">
<div class="x_title">
	<h2>My Rank Rules Missed</small></h2>
...
foreach ($json['rankrulesmissed'] as $record)
{
	...
	echo "<td align=center>".DispQualifyType($record['qualifytype'])."</td>";
