...
$json = BuildAndPOST(CLIENT, "querycommissions", $fields, $pagvals);
...
foreach ($json['commissions'] as $commission)
{
	...
	echo "<td align=center>".$commission['firstname']." ".$commission['lastname']." (".$commission['userid'].")</td>";
