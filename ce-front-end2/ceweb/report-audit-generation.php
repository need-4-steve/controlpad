...
$fields[] = "batchid";
$json = BuildAndPOST(CLIENT, "queryauditgen", $fields, $pagvals);
...
<div class="x_panel">
<div class="x_title">
	<h2>Generation Audit Report - Batch: <?=$_SESSION['batchid']?></small></h2>
...
foreach ($json['auditgen'] as $value)
{
...
{
	echo "<tr>";
	echo "<td align=center><b>Generation ".$value['generation']."</b></td>";
